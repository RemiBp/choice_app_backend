...
// Modèle pour les tags de contacts
const ContactTag = choiceAppDb.model('ContactTag', contactTagSchema, 'contact_tags');
...
// Modèle pour les associations de tags de contacts
const ContactTagAssociation = choiceAppDb.model('ContactTagAssociation', contactTagAssociationSchema, 'contact_tag_associations');

module.exports = { ContactTag, ContactTagAssociation }; 