...
// Création des modèles une seule fois
const User = choiceAppDb.model('User', UserSchema, 'users');
const UserChoice = choiceAppDb.model('UserChoice', UserSchema);
const UserRest = restDb.model('UserRest', UserSchema);
