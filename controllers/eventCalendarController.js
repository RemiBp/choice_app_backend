...
const EventSchema = new mongoose.Schema({
  ...
  recurrence: {
    type: { type: String, enum: ['daily', 'weekly', 'monthly', 'yearly', 'custom', 'none'], default: 'none' },
...
// Ajouter un index géospatial à la collection d'événements
EventSchema.index({ location: '2dsphere' });

// Modèle pour les événements
const Event = choiceAppDb.model('Event', EventSchema, 'events');
...
// Modèle pour les inscriptions d'événements
const EventRegistration = choiceAppDb.model('EventRegistration', EventRegistrationSchema, 'event_registrations');
